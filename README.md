...
<div align="center">
  ...
  <p style="font-size: 0.75em; line-height: 1.1; color: #666; display: block; max-width: 70%; margin: 0 auto;">The vision transformer network consists of partitioning the source MNase-seq images into patches, fed into transformer encoder blocks and merged into a feed-forward multilayer perceptron to predict an output transcript level.</p>
</div>
...
<div align="center">
	...
	<p style="font-size: 0.75em; line-height: 1.1; color: #666; display: block; max-width: 70%; margin: 0 auto;">
